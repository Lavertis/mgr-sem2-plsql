DECLARE
    ...
    TabEgz   tab_eg;
    vsp      VARCHAR2(1);
    CURSOR S_Przedmioty IS SELECT 'x'
                           FROM Przedmioty;
    ind      NUMBER(5) := 0;
    x        NUMBER;
    maxidegz NUMBER(1) := 4;
...
BEGIN
    ...
    DELETE FROM Osrodki;
    commit;
    FOR i IN 1..TabOs.LAST
        LOOP
            INSERT INTO Osrodki(id_osrodek, Nazwa_Osrodek, miasto)
            VALUES (TabOs(i).Id_Osrodek,
    ...
    commit;
    FOR i IN 1..TabSt.LAST
        LOOP
            INSERT INTO Studenci(id_student, nazwisko, imie)
            VALUES (TabSt(i).Id_Student,
    ...
    commit;
    FOR i IN 1..TabWyk.LAST
        LOOP
            INSERT INTO Egzaminatorzy(id_egzaminator, nazwisko, imie)
            VALUES (TabWyk(i).Id_Egzaminator,
    ...
    FOR i IN 1..TabEgz.LAST
        LOOP
            INSERT INTO Egzaminy(ID_Egzamin, id_student, id_przedmiot, id_egzaminator, id_osrodek, Data_Egzamin, zdal,
                                 punkty)
